...
out = cv2.VideoWriter('up_down1_pocuro.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 10, (frame_width,frame_height))
                ...
                for i in persons:
                    if abs(cx-i.getX()) <= w and abs(cy-i.getY()) <= h:
                        ...
                        if i.going_UP(line_down,line_up) == True:
                            cnt_up += 1;
                            print "ID:",i.getId(),'cruzando hacia arriba a las ',time.strftime("%c")
                        elif i.going_DOWN(line_down,line_up) == True:
                            cnt_down += 1;
                            print "ID:",i.getId(),'cruzando hacia abajo a las  ',time.strftime("%c")
                        break
                    if i.getState() == '1':
...
##            print str(i.getX()), ',', str(i.getY())
    ...
    #   IMAGANES    #
    #################
    str_up = 'ARRIBA: '+ str(cnt_up)
    str_down = 'ABAJO: '+ str(cnt_down)
